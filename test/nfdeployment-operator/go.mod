...
replace github.com/s3wong/nephio-code/free5gc-upf => /home/skfwong_google_com/test/free5gc-upf

require (
	github.com/nephio-project/api v1.0.1-0.20231006162045-9ad2d0db2a8d
	github.com/onsi/ginkgo/v2 v2.14.0
	github.com/onsi/gomega v1.30.0
	github.com/s3wong/nephio-code/free5gc-upf v0.0.0-00010101000000-000000000000
